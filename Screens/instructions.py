...
The goal of this game is to collect as many stars as possible
Mechanics:
You cannot pass through blobs.
The higher the difficulty the more blobs there are.
Controls:
Your player follows the mouse."""
